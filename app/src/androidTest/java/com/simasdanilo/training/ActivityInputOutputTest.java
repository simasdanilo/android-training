...
public class ActivityInputOutputTest {
    ...
    public void activityLaunch() {
        ...
        onView(withId(R.id.text_header_message)).check(matches(isDisplayed()));
    ...
    public void textInputOutput() {
        ...
        onView(withId(R.id.editText_message)).perform(typeText(testMessage));
        onView(withId(R.id.button_send)).perform(click());
    ...
    public void useAppContext() {
        ...
        assertEquals("com.simasdanilo.training", appContext.getPackageName());
    }
}
